...
// let _user = ensure_signed(origin)?;
//         <exchange_core::Module<T>>::MinimumMakerProtocolFee::<T>::put(new_minimum_maker_protocol_fee);
...
//         <exchange_core::Module<T>>::MinimumTakerProtocolFee::<T>::put(new_minimum_taker_protocol_fee);
...
// <exchange_core::Module<T>>::ProtocolFeeRecipient::<T>::put(new_protocol_fee_recipient.clone());
...
impl<T: Trait> Module<T> {
    ...
    pub fn calculate_final_price_ex(
        ...
        let b = <sale_kind_interface::Module<T>>::calculate_final_price(
            &side,
            &sale_kind,
            base_pricex,
            extra,
    ...
    pub fn orders_can_match_ex(
        ...
        <exchange_core::Module<T>>::orders_can_match(&bs[0], &bs[1]).unwrap()
    }
